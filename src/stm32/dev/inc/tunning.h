...
// D�termine le buffer qui doit �tre rempli
...
/******************** IDENTIFICATION ****************************/
// M�thode pour effetuer l'identifications des roues � partir de deux �chelons de consigne
void tunningIdentificationWheels();
void tunningSendIdenWheels();

/******************** PI VITESSE ********************************/
// Permet de comparer la consigne avec la r�ponse d'un syst�me � une consigne
void tunningSpeedPI();
// PErmet d'Envoyer les donn�es relatives � l'analyse de la r�ponse du PID
...
// Permet d'envoyer les donn�es du test de PID de position
